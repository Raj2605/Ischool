...
?>  
    ...
    <div class="container mt-5"> <!-- Start Most Popular Course -->
      ...
      <div class="card-deck mt-4" > <!-- Start Most Popular Course 1nd Card Deck -->
        <?php
        ...
        ?>
      </div>   <!-- End Most Popular Course 1nd Card Deck --> 
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>iSchool Pvt Ltd <br> Near Shaniwar wada  <br> Pune, Maharashtra <br> Ph. +912567865678 </p>
          </div>
        </div>
      </div>
